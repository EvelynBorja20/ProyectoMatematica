...
const CalculadoraFinanciera = {
  ...
  procesarCalculo() {
    ...
    this.outputs.interes.textContent = interesGenerado.toLocaleString("es-MX", formatoMoneda);
    this.outputs.total.textContent = montoTotal.toLocaleString("es-MX", formatoMoneda);
  }
};
